...
/**
 * Created by neopoliticatv on 04/03/15.
 */
public class FriendsDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if(command.equals(DELETE_RECORD)){
            ...
            popupMessage.setText("Are you sure want to delete " +name +" from your friends list?");
            ...
            Log.d(LOG_TAG,"Invalid coomand passed as parameter");
        }
