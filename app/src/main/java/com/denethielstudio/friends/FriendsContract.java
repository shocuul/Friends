...
public class FriendsContract {
    ...
    public static final String CONTENT_AUTHORY = "org.example.android.friends.provider";
    ...
    public static class Friends implements FriendsColumns, BaseColumns{
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.item/vnd." + CONTENT_AUTHORY + ".friends";
